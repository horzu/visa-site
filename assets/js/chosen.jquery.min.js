      ...
      return (
          ...
          for (b = "", f = this.results_data, d = 0, e = f.length; e > d; d++)
            (c = f[d]),
              ...
              (null != a ? a.first : void 0) &&
                (c.selected && this.is_multiple ? this.choice_build(c) : c.selected && !this.is_multiple && this.single_set_selected_text(c.text));
          return b;
        }),
        ...
        (AbstractChosen.prototype.result_add_group = function (a) {
          ...
          return a.search_match || a.group_match
            ? a.active_options > 0
              ? ((b = document.createElement("li")), (b.className = "group-result"), (b.innerHTML = a.search_text), this.outerHTML(b))
              : ""
            : "";
        }),
        ...
        (AbstractChosen.prototype.winnow_results = function () {
          ...
          for (
            this.no_results_clear(),
              ...
              a = g.replace(/(([İIŞĞÜÇÖiışğüçö]))/g, function (letter) {
            ...
            (b = m[k]),
              ...
              this.include_option_in_results(b) &&
                ...
                null != b.group_array_index &&
                  ...
                  ((f = this.results_data[b.group_array_index]), 0 === f.active_options && f.search_match && (e += 1), (f.active_options += 1)),
      ...
      return (
        ...
        (Chosen.prototype.container_mousedown = function (b) {
          return this.is_disabled ||
            (b && "mousedown" === b.type && !this.results_showing && b.preventDefault(), null != b && a(b.target).hasClass("search-choice-close"))
            ? void 0
            : (this.active_field
                ? this.is_multiple ||
                  !b ||
        ...
        (Chosen.prototype.search_results_mousewheel = function (a) {
          ...
          return (
            ...
            null != b
              ? (a.preventDefault(), "DOMMouseScroll" === a.type && (b = 40 * b), this.search_results.scrollTop(b + this.search_results.scrollTop()))
              : void 0
          );
        }),
        ...
        (Chosen.prototype.search_results_mouseover = function (b) {
          var c;
          return (
            (c = a(b.target).hasClass("active-result") ? a(b.target) : a(b.target).parents(".active-result").first()), c ? this.result_do_highlight(c) : void 0
          );
        }),
          ...
          return this.results_showing || this.is_multiple
            ? this.result_highlight
              ? ((a = this.result_highlight.prevAll("li.active-result")),
                a.length ? this.result_do_highlight(a.first()) : (this.choices_count() > 0 && this.results_hide(), this.result_clear_highlight()))
              : void 0
            : this.results_show();
        }),
